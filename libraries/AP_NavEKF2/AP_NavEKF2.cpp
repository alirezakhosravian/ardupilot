...
const AP_Param::GroupInfo NavEKF2::var_info[] PROGMEM = {
    ...
    // @Increment: 10
    // @User: Advanced
    AP_GROUPINFO("VEL_DELAY",    14, NavEKF2, _msecVelDelay, 220),
    ...
    // @Increment: 10
    // @User: Advanced
    AP_GROUPINFO("POS_DELAY",    15, NavEKF2, _msecPosDelay, 220),
...
*/
void NavEKF2::EstimateTerrainOffset()
{
    // start performance timer
...
void NavEKF2::RecallOmega(Vector3f &omegaAvg, uint32_t msecStart, uint32_t msecEnd)
{
...
void NavEKF2::getFlowDebug(float &varFlow, float &gndOffset, float &flowInnovX, float &flowInnovY, float &auxInnov, float &HAGL, float &rngInnov, float &range, float &gndOffsetErr) const
{
...
bool NavEKF2::readDeltaAngle(uint8_t ins_index, Vector3f &dAng) {
    const AP_InertialSensor &ins = _ahrs->get_ins();
...
void NavEKF2::InitialiseVariables()
{
...
bool NavEKF2::useRngFinder(void) const
{
...
bool NavEKF2::optFlowDataPresent(void) const
{
...
bool NavEKF2::getVehicleArmStatus(void) const
{
...
// Check arm status and perform required checks and mode changes
void NavEKF2::performArmingChecks()
{
...
bool NavEKF2::getTakeoffExpected()
{
...
bool NavEKF2::getTouchdownExpected()
{
...
bool NavEKF2::calcGpsGoodToAlign(void)
{
...
void NavEKF2::readRangeFinder(void)
{
...
void NavEKF2::detectOptFlowTakeoff(void)
{
...
void NavEKF2::getQuaternion(Quaternion& ret) const
{
    ret = state.quat;
}

// align the NE earth magnetic field states with the published declination
void NavEKF2::alignMagStateDeclination()
{
    // get the magnetic declination
    float magDecAng = use_compass() ? _ahrs->get_compass()->get_declination() : 0;
